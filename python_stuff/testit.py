...
button1 = Button(root, text='Sort the listbox    ', command=sort_list)
button1.grid(row=2, column=0, sticky=W)
# button to save the listbox's data lines to a file
button2 = Button(root, text='Save lines to file', command=save_list)
button2.grid(row=3, column=0, sticky=W)
# button to add a line to the listbox
button3 = Button(root, text='Add entry text to listbox', command=add_item)
button3.grid(row=2, column=0, sticky=E)
# button to delete a line from listbox
button4 = Button(root, text='Delete selected line     ', command=delete_item)
button4.grid(row=3, column=0, sticky=E)
